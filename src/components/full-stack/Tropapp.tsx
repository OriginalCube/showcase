      ...
      <div className="w-full h-auto flex flex-col gap-24 items-center justify-center">
        <div className="w-full md:w-2/3 h-auto flex flex-col md:flex-row gap-4 items-center justify-around">
          <div className="w-auto h-auto flex flex-col">
            <a
              href="https://github.com/OriginalCube/tropapp"
              target="_blank"
              rel="noopener"
              className="text-5xl md:text-8xl w-full md:w-1/2 font-bold text-blue-400 text-center md:text-left"
            >
              Tropapp
            </a>
          ...
          <p className="relative w-5/6 md:w-1/2 text-md font-light text-justify text-slate-800">
            ...
            <div className="w-full md:w-2/3 flex flex-col h-auto items-center justify-center gap-32 mb-10">
              <div className="w-full h-auto flex flex-col md:flex-row items-center justify-center gap-10 md:gap-24">
                ...
                <div className="w-full md:w-1/3 h-auto flex flex-col gap-2 items-center">
                  ...
                  <p className="text-xl text-justify w-5/6 md:w-auto md:text-left h-auto">
                    This is the login/register page where users will provide
                    their credentials to be able to use the website and are
                    encrypted.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full h-auto flex flex-col md:flex-row items-center justify-center gap-10 md:gap-24">
                ...
                <div className="w-full md:w-1/3 h-auto flex flex-col gap-2 items-center">
                  ...
                  <p className="text-xl text-justify w-5/6 md:w-auto md:text-left h-auto">
                    This page display the post of the user and allows the user
                    to edit certain data regarding his account. Displayed post
                    here from the user can also be edited and be deleted if
                    wanted.
                  </p>
                </div>
              </div>
              <div className="w-full h-auto flex flex-col-reverse md:flex-row items-center justify-center gap-10 md:gap-24">
                <div className="w-full md:w-1/3 h-auto flex flex-col gap-2 items-center">
                  ...
                  <p className="text-xl text-justify w-5/6 md:w-auto md:text-left h-auto">
                    This page will allow user to message each other through
                    joining with a specific code that can be input on chat page,
                    or directly going into their account and clicking on the
                    message icon.
                  </p>
                </div>
                <motion.img
